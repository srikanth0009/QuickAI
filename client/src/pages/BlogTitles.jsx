  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start gap-4 text-slate-700">
      <form
        ...
        className="w-full max-w-lg bg-white rounded-lg border border-gray-200 p-4"
      >
        ...
        <input
          ...
          required
        />
        <p className="mt-4 text-sm font-medium">Cateogry</p>
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>Enter a topic and click "Generate tittle" to get started</p>
            </div>
          </div>
        ) : (
